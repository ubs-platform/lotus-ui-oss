...
- `npx storybook@latest automigrate --config-dir libs/front-global/button/.storybook`

- `npx storybook@latest automigrate --config-dir libs/front-global/loading-indicator/.storybook`

- `npx storybook@latest automigrate --config-dir libs/front-global/ubs-touch-ngx/.storybook`
