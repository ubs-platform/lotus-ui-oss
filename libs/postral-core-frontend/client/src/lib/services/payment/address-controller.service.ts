...
export class AddressControllerService extends CrudBaseServiceGenerator<AccountAddressDto, AccountAddressDto, AddressSearchParamsDTO>("/service/payment/api/address") {
  /**
   *
   */
